...
export default function GraphPage({ onBack, initialRepositoryUrl }: GraphPageProps) {
  ...
  const loadEnhancedTraceabilityGraph = async () => {
    try {
      const response = await fetch(`${DIRECT_API_CONFIG.BASE_URL}/api/v1/graph/enhanced-traceability`)
      if (response.ok) {
  ...
  const handleGenerateGraph = async () => {
    ...
    try {
      ...
      const response = await fetch(`${DIRECT_API_CONFIG.BASE_URL}/api/v1/graph/dependency`, {
        method: 'POST',
        headers: {
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gradient-to-br from-purple-900 to-blue-900 rounded-lg p-6 text-white">
                    <div className="text-center mb-4">
                      <h3 className="text-2xl font-bold mb-2">🌳 GraphTrace Hierarchical Traceability</h3>
                    ...
                    <div className="bg-white bg-opacity-10 rounded-lg p-4 mb-6">
                      <h4 className="font-semibold mb-2">📋 Analysis Description</h4>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 min-h-96 border">
                    <div className="text-center text-gray-600 py-8">
                      ...
                      <p className="text-sm text-gray-500 mt-2">
                        Graph data generated successfully! In a full implementation, this would show an interactive D3.js or Cytoscape.js visualization.
                      </p>
                      <div className="mt-4 flex justify-center space-x-2">
                        <button className="px-3 py-1 bg-blue-100 text-blue-800 rounded text-sm">Zoom In</button>
                        <button className="px-3 py-1 bg-blue-100 text-blue-800 rounded text-sm">Zoom Out</button>
                        <button className="px-3 py-1 bg-blue-100 text-blue-800 rounded text-sm">Reset View</button>
                        <button className="px-3 py-1 bg-green-100 text-green-800 rounded text-sm">Export PNG</button>
                      </div>
                    </div>
                  </div>
