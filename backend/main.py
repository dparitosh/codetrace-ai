...
app = FastAPI(
    title="CodeTrace AI",
    description=(
        "CodeTrace AI analyzes source code and exposes normalized graph, quality, "
        "security, and traceability data through a documented REST API."
    ),
    version="1.0.0",
    contact={"name": "CodeTrace AI API Support"},
    license_info={"name": "MIT"},
    openapi_tags=[
        {"name": "Graph Generation", "description": "Repository and local-source graph generation endpoints."},
        {"name": "Graph Analysis", "description": "Graph construction and audit operations."},
        {"name": "Code Analysis", "description": "Source-code analysis endpoints."},
        {"name": "Quality Assessment", "description": "Quality metrics and recommendations."},
        {"name": "Security", "description": "Security and compliance operations."},
    ],
    docs_url="/docs",
    redoc_url="/redoc",
